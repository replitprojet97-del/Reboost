...
function getEmailLogoUrl(): string {
  // Use the official SolventisGroup email-optimized minimalist logo
  return "https://solventisgroup.org/attached_assets/generated_images/minimalist_professional_blue_logo_for_solventisgroup_emails.png";
}
...
const translations = {
  ...
  pt: {
    ...
    transferCompletedUser: {
      subject: "Sua transferência foi concluída - SOLVENTIS GROUP",
  ...
  it: {
    ...
    transferCompletedUser: {
      subject: "Il tuo trasferimento è stato completato - SOLVENTIS GROUP",
  ...
  de: {
    ...
    transferCompletedUser: {
      subject: "Ihre Überweisung wurde abgeschlossen - SOLVENTIS GROUP",
