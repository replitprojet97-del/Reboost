...
export default function InfoBarPremium() {
  const messages = [
    { icon: CreditCard, text: "Les virements Altus sont désormais traités sous 24h ouvrées." },
    ...
    { icon: Briefcase, text: "Altus Finance Group – Solutions professionnelles haut de gamme." }
  ];
