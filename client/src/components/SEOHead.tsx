...
export function SEOHead({
  ...
  const siteUrl = import.meta.env.VITE_SITE_URL || 'https://solventisgroup.org';
  ...
  return (
    <Helmet>
      ...
      <meta property="og:site_name" content="Solventis Group" />
      ...
      <meta name="author" content="Solventis Group" />
