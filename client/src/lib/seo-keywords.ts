...
export function getTermsSEOByLocale(locale: string = 'fr'): { title: string; description: string; keywords: string } {
  const seoByLang = {
    fr: {
      title: 'Conditions Générales d\'Utilisation - SolventisGroup',
    ...
    en: {
      title: 'Terms of Service - SolventisGroup',
    ...
    es: {
      title: 'Términos de Servicio - SolventisGroup',
    ...
    pt: {
      title: 'Termos de Serviço - SolventisGroup',
    ...
    it: {
      title: 'Condizioni d\'uso - SolventisGroup',
    ...
    de: {
      title: 'Nutzungsbedingungen - SolventisGroup',
...
export function getPrivacySEOByLocale(locale: string = 'fr'): { title: string; description: string; keywords: string } {
  const seoByLang = {
    fr: {
      title: 'Politique de Confidentialité - SolventisGroup',
    ...
    en: {
      title: 'Privacy Policy - SolventisGroup',
    ...
    es: {
      title: 'Política de Privacidad - SolventisGroup',
    ...
    pt: {
      title: 'Política de Privacidade - SolventisGroup',
    ...
    it: {
      title: 'Politica sulla privacy - SolventisGroup',
    ...
    de: {
      title: 'Datenschutzrichtlinie - SolventisGroup',
...
export function getProductsSEOByLocale(locale: string = 'fr'): { title: string; description: string; keywords: string } {
  const seoByLang = {
    fr: {
      title: 'Nos Produits de Financement - SolventisGroup',
    ...
    en: {
      title: 'Our Financing Products - SolventisGroup',
    ...
    es: {
      title: 'Nuestros Productos de Financiación - SolventisGroup',
    ...
    pt: {
      title: 'Nossos Produtos de Financiamento - SolventisGroup',
    ...
    it: {
      title: 'I Nostri Prodotti di Finanziamento - SolventisGroup',
    ...
    de: {
      title: 'Unsere Finanzierungsprodukte - SolventisGroup',
...
export function getResourcesSEOByLocale(locale: string = 'fr'): { title: string; description: string; keywords: string } {
  const seoByLang = {
    fr: {
      title: 'Ressources et FAQ - SolventisGroup',
    ...
    en: {
      title: 'Resources and FAQ - SolventisGroup',
    ...
    es: {
      title: 'Recursos y Preguntas Frecuentes - SolventisGroup',
    ...
    pt: {
      title: 'Recursos e Perguntas Frequentes - SolventisGroup',
    ...
    it: {
      title: 'Risorse e Domande Frequenti - SolventisGroup',
    ...
    de: {
      title: 'Ressourcen und Häufig Gestellte Fragen - SolventisGroup',
